...
{
    NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:picture.image1]];
    UIImage *image = [UIImage imageWithData:imageData];
   
    ShareView *shareView = [ShareView createViewFromNib];
    
    [shareView setShareController:self Content:picture.text Image:image URL:picture.profile_image Title:picture.screen_name];
